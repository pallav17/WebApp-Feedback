    ...
    $scope.Save = function () {
        if ($scope.FName == undefined || $scope.LName == undefined || $scope.office == undefined || $scope.email == undefined || $scope.password == undefined || $scope.cpassword == undefined )
            ...
            $http({
                ...
                data: { FirstName: $scope.FName, LastName: $scope.LName, Office: $scope.office, Email: $scope.email, Password: $scope.password, PhoneNo: $scope.phone, IsActive: false, IsDelete: false }
